...
The $p$-intercept of this graph is $p=0.104$. Meaning, with a proportion of 10.4 percent or less, there is going to be a damped oscillation.
...
\autoref{plot:R_0} tells us, With the proportion of intentional infection $p>0.3$, the system has no damped oscillation for a reasonable value of $\R_0$.
